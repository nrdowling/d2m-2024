---
title             : "An Example Papaja Notebook with Lots of Kable Problems"
shorttitle        : "Not a great example"
...
```{r table-size-scaleup, warning=FALSE, results='asis'}
...
There is **so much more** you can do with kables! ~~I am personally a huge fan of kables and the kableExtra package because it works beautifully with papaja~~[^1], but you can also explore other packages for making beautiful tables:

[^1]: Tragically this is no longer true. Many `kableExtra` functions now (as of Feb 2024) break spectacularly in papaja notebooks. 
