...
```{r plot-primary-results, echo=FALSE, fig.cap="Miles per gallon as a function of nunber of cylinders and transmission type in the `mtcars` dataset.", results='asis'}
...
- Brackets: `[@dowling2024d2mr]` [@dowling2024d2mr]
- No brackets: `@dowling2024d2mr` @dowling2024d2mr
- Brackets and hyphen: `[-@dowling2024d2mr]` [-@dowling2024d2mr]
- No brackets and hyphen: `-@dowling2024d2mr` -@dowling2024d2mr **<-- not useful**

In APA6 format, the first time a paper with many authors was mentioned you were supposed to list out all the authors, then use "et al." for subsequent references. In APA7 that has changed, so that you use "et al." for citations with three or more authors every time. So when I refer to a many-authored paper [@douglas2022introduction] the first time, that may or may not look different than when I call that paper [@douglas2022introduction] a second time.
